      ...
      <div className='dark:bg-[#200A4C] lg:px-36'>
        ...
        <div className='border-t-[16px] border-b-[16px] lg:border-[16px] border-gray-100 dark:border-[#301B59] overflow-hidden  relative max-w-screen-md' style={{margin: 'auto'}}>
          ...
          <div className='w-full'>
            {/* <img src={images.VideoBanner} alt="" className='object-cover h-full w-full' /> */}
            {/* <video src='https://www.youtube.com/watch?v=dgjZ2fHg4y4'></video> */}
          ...
          {/* <div className='pl-6 lg:pl-10 pr-20 lg:pr-28 py-6 lg:py-8 bg-black/70 border-l-2 border-[#B868F1] absolute top-10 left-10 text-gray-300 space-y-2 xl:hidden'>
